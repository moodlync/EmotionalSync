/**
 * Simple Replit-compatible forwarder for MoodLync
 * This file runs as a standalone process to forward traffic from port 3000 to 5000
 */
...
server.listen(FROM_PORT, HOST, () => {
  log(`Simple Replit Forwarder running at http://${HOST}:${FROM_PORT}`);
...
// Log startup
log('Starting MoodLync Replit Forwarder...');